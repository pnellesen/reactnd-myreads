            ...
            <div className="list-books-content">
              <div>
          	 	{/* 
                    ...
                    componentDidMount will retrieve all books on the shelf specified by the shelfId prop. 
                    State might be something like {id: shelfId, booklist: [array of current book ids]}
                */}
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
                      <li>
          				{/*
                        	Create a "Book" component, takes prop of bookId. Used to get the various attributes of the book from BooksAPI.js.
                            State will likely be something like "currentShelf". Probably want this state to be controlled by the book component.
                        */}
                        <div className="book">
                          <div className="book-top">
                            <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: 'url("http://books.google.com/books/content?id=PGR2AwAAQBAJ&printsec=frontcover&img=1&zoom=1&imgtk=AFLRE73-GnPVEyb7MOCxDzOYF1PTQRuf6nCss9LMNOSWBpxBrz8Pm2_mFtWMMg_Y1dx92HT7cUoQBeSWjs3oEztBVhUeDFQX6-tWlWz1-feexS0mlJPjotcwFqAg6hBYDXuK_bkyHD-y&source=gbs_api")' }}></div>
          					...
          					{/*
                                ...
                                option is selected. onSelect will move the book to the correct bookshelf via BooksAPI.js
